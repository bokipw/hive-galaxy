-- =====================================================
-- HIVE GALAXY — POTPUNO NOVA BAZA (v3 clean + missing tables)
-- Pokreni u Supabase Dashboard -> SQL Editor
-- =====================================================

-- =====================================================
-- 1. BRISANJE SVIH TABELA (ako postoje)
-- =====================================================
...
DROP TABLE IF EXISTS season_archives CASCADE;
...
-- =====================================================
-- 4. TRIGGER — sprjecava prazan save (dupla zastita)
-- =====================================================
...
-- =====================================================
-- 8. WITHDRAWALS — Povlacenje tokena
-- =====================================================
...
CREATE POLICY "wd_read_all"   ON withdrawals FOR SELECT USING (true);
CREATE POLICY "wd_write_all"  ON withdrawals FOR INSERT WITH CHECK (true);
CREATE POLICY "wd_update_all" ON withdrawals FOR UPDATE USING (true);
CREATE POLICY "wd_delete_all" ON withdrawals FOR DELETE USING (true);

-- =====================================================
-- 9. PREMIUM_USERS — Spisak premium korisnika
-- =====================================================
CREATE TABLE premium_users (
  ...
  PRIMARY KEY (email, hive_user)
);

ALTER TABLE premium_users ENABLE ROW LEVEL SECURITY;

CREATE POLICY "pu_read_all"   ON premium_users FOR SELECT USING (true);
CREATE POLICY "pu_write_all"  ON premium_users FOR INSERT WITH CHECK (true);
CREATE POLICY "pu_update_all" ON premium_users FOR UPDATE USING (true);
CREATE POLICY "pu_delete_all" ON premium_users FOR DELETE USING (true);

-- =====================================================
-- 10. SEASON_ARCHIVES — Arhiva sezona
-- =====================================================
...
CREATE POLICY "sa_read_all"   ON season_archives FOR SELECT USING (true);
CREATE POLICY "sa_write_all"  ON season_archives FOR INSERT WITH CHECK (true);
...
CREATE INDEX IF NOT EXISTS idx_sa_season    ON season_archives(season DESC);

-- =====================================================
-- 12. INSERT sistema — HIVE profil za maintenance check
-- =====================================================
INSERT INTO hive_profiles (hive_user, is_premium, keys, boosters)
VALUES ('__system__', false, 0, '{}')
ON CONFLICT (hive_user) DO NOTHING;
