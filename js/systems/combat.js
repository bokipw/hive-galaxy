  ...
  const body = `
    ...
    <div style="text-align:center;margin-bottom:20px">
      ...
      <div style="font-size:0.72rem;color:#6a90b8;margin-top:4px">
        ${t('index.instance.completed_in',{round:battle.round})}
      </div>
    </div>
    ...
    ${isVictory && rewards ? `
      <div style="background:rgba(0,255,136,0.05);border:1px solid rgba(0,255,136,0.2);
        ...
        <div style="font-size:0.72rem;color:#00ff88;font-weight:700;margin-bottom:10px">${t('index.instance.rewards')}</div>
        ...
        ${(rewards.blueprints||[]).length > 0 ? `
          <div style="font-size:0.65rem;color:#6a90b8;margin-bottom:6px">${t('index.instance.blueprints_header')}</div>
        ...
        ${(rewards.fragments||[]).length > 0 ? `
          <div style="font-size:0.65rem;color:#6a90b8;margin-bottom:6px">${t('index.instance.fragments_header')}</div>
          <div style="display:flex;flex-wrap:wrap;gap:4px;margin-bottom:6px">
